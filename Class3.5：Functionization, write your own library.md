...
2. 從官網中找到自己系統的下載版本[Simplified Wrapper and Interface Generator](https://www.swig.org/), https://open-box.readthedocs.io/zh-cn/latest/installation/install_swig.html, 其中Mac可以用`brew install swig`
