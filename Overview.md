...
Please make sure to bring your laptop for the session. It is better to use a personal computer since using a different computer may significantly slow down the setup process let you complete the exercises before the class ends.
