...
Please make sure to bring your laptop for the session. It is better to use a personal computer since using a computer may significantly slow down the setup process Additionally, reviewing the slides in advance may help you complete the exercises before the class ends.
