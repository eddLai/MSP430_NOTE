...
7. 函式化：[[Class 7：High-Speed SPI Data Transfer – MicroSD Large File Handling & Ethernet Performance in Energia]]SPI的MicroSD讀寫大檔案的傳輸速度+SPI乙太端口，Energia的極限, 線材長度影響
