...
---
今天教的架構比較困難，許多同學都遇到了無法使用Serial.println()出自己想要的東西，這是因為需要同時使用Hardware UART and Software UART，因此我們一步一步來，先使用Hardware UART就好，請所有人確保下週二時能做到影片中的這依然是我們過幾個禮拜後的目標，